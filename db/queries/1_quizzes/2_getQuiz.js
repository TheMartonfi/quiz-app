...
const getQuiz = function(db, options){
  return db.query(`
  SELECT quizzes.id, quizzes.owner_id, title, category, description, time_limit, COUNT(results.*) as times_played, AVG(quiz_rating) as average_rating, quizzes.image
  FROM quizzes
